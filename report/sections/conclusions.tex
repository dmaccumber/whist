...
it rewards optimization. The AI's advantage over the heuristic (53.8\% win
rate, statistically significant at $p < 0.05$) comes from exact Phase~2
play via minimax and card counting, which together enable optimal endgame
decisions.
...
\begin{itemize}
  ...
  \item Phase~1 and Phase~2 use identical card-acquisition heuristics,
    limiting the AI's ability to differentiate in the opening. A stronger
    Phase~1 strategy could widen the gap.
