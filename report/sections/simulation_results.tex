...
\begin{tabular}{llccc}
\toprule
Player 0 & Player 1 & Games & P0 Win\% & 95\% CI \\
\midrule
Random & Random & 2000 & 49.5\% & [47.3, 51.6] \\
Heuristic & Random & 2000 & 93.0\% & [91.8, 94.1] \\
AI & Random & 2000 & 91.8\% & [90.6, 93.0] \\
AI & Heuristic & 2000 & 53.8\% & [51.7, 56.0] \\
Heuristic A & Heuristic B & 2000 & 48.9\% & [46.7, 51.1] \\
\bottomrule
\end{tabular}
\end{center}
...
The AI wins 91.8\% of games against random play, closely matching the
heuristic's 93.0\%. Both use the same rule-based Phase~1 strategy. The small
...
exact C++ minimax solver, which plays optimally in all 13 Phase~2 tricks. The
...
first) wins 49.5\% of games (95\% CI: [47.3\%, 51.6\%])---consistent with no
significant first-player advantage. In heuristic-vs-heuristic games, Player~0
wins 48.9\% (95\% CI: [46.7\%, 51.1\%]), also not significant. Neither player
position confers a meaningful advantage.
