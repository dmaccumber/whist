...
\begin{itemize}
  ...
  \item \textbf{Hybrid depth:} For the initial moves (13 cards each), we use a
    3-trick lookahead with a quick-trick evaluation function, switching to
    exact solve when hands shrink to 10 or fewer cards ($<100$ms each).
\end{itemize}
